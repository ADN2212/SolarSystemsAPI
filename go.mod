module solarsystems.com

go 1.23.4

replace solarsystems.com/endpoints => ./endpoints
...
require (
	...
	solarsystems.com/middlewares v0.0.0-00010101000000-000000000000
)
...
replace solarsystems.com/middlewares => ./middlewares
